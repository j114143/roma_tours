...
<div class="row">
    <div class="col-sm-8">
      {!! Form::model($obj, [ 'method' => 'POST','files'=>true,'url'=>route('buses_conductor',['id'=>$obj->id]),'id'=>'form','class'=>'form-horizontal','onsubmit'=>'return checkSubmit();']) !!}
        <div class="form-group">
          <label for="inputImage" class="col-sm-2 control-label">Imagen</label>
          <div class="col-sm-10">
            {!! Form::select('conductor_id', $conductores->toArray(), null, array('class' => 'form-control','id' => 'conductor_id')) !!}
          </div>
        </div>
        <div class="form-group">
